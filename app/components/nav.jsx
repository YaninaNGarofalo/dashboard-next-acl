    ...
    return (
            ...
            <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
               <div className="flex justify-center w-full pt-6">
                  <Image className="w-1/4" width={67} height={67} src={"/logo.png"} alt="logo Access Control Log" />                  
               </div>
               <p className="w-full text-gray-900 rounded-lg dark:text-gray-400 text-center pb-6">Access Control Log</p>
